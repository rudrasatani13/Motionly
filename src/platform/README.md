...
Reserved. Adapters are introduced as their features are built (camera in Phase 16, voice in Phase 25, storage in Phase 30, notifications in Phase 44). Currently empty by design.
